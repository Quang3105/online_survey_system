		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$chuc_vu = array('',"Admin","Giảng Viên", "Sinh Viên", "Doanh nghiệp", "Cựu Sinh Viên");
					$qry = new Admin();
					$res = $qry->thongKeNguoiDung(5);
					...
					<tr>
                        ...
                        <td><b><?php echo $row['khoa'] ?></b></td>
                        <td><b><?php echo $row['lop'] ?></b></td>
                        <td><b><?php echo $row['nam'] ?></b></td>
                        <td><b><?php echo $row['dia_chi'] ?></b></td>
